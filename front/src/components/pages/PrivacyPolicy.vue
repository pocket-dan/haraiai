  ...
  <div class="privacy-policy-page">
    ...
    <p>
      ...
      <ul>
        ...
        <li>本サービスのウェブサイトの滞在時間、入力履歴、購買履歴等の本サービスのウェブサイトにおけるお客様の行動履歴</li>
        <li>LINEアプリ上で本サービスの公式アカウントをメンバーとして追加しているグループ内で投稿されるテキスト、画像、動画のコンテンツやアクセスログなど、お客様のサービス利用状況に関する情報</li>
      </ul>
    </p>
